def cnewsum_setting(args):
    ...
    args.mle_weight = getattr(args, "mle_weight", 20)
    args.rank_weight = getattr(args, "rank_weight", 1)
    args.model_type = getattr(args, "model_type", "./bart-base-chinese")
    ...
    args.dataset = getattr(args, "dataset", "data/CNewSum_v2")
    args.max_len = getattr(args, "max_len", 510)
...
def cnndm_setting(args):
    ...
    args.model_type = getattr(args, "model_type", "../pretrained_models/bart-base")
    args.warmup_steps = getattr(args, "warmup_steps", 10000)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
    ...
    args.score_mode = getattr(args, "score_mode", "log")
    args.datatype = getattr(args, "datatype", "diverse")
    args.dataset = getattr(args, "dataset", "data/cnndm")
